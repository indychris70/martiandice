 ...
 * martiandice implementation : © <Your name here> <Your email address here>
 *
 ...
 * gameoptions.inc.php
 *
 * martiandice game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in martiandice.game.php)
 *
